...
package com.camangi.netconnect.wifi;

import com.camangi.netconnect.wifi.ProgressCategory;
import com.camangi.netconnect.R;
...
import com.camangi.netconnect.AboutWiFi;
/**
...
public class WifiSettings extends PreferenceActivity implements WifiLayer.Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RunThread_CheckWifi CheckWifi_Thread = new RunThread_CheckWifi();
        CheckWifi_Thread.start();
    ...
    public void onRetryPassword(AccessPointState ap) {
        ...
        // If WiFi connected, finish this application WifiSettings
        public class RunThread_CheckWifi extends Thread {
                public void run() {
                        try {
                                while(true) {
                                        sleep(1000);
                                        if (aboutWiFi.isWifiEnabled(WifiSettings.this)) {
